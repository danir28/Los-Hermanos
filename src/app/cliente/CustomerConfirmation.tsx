...
// Pantalla de confirmación tras crear un pedido, con resumen y acceso al seguimiento.
export function CustomerConfirmation({ orderId, orders, onTrack }: { orderId: string; orders: Order[]; onTrack: () => void }) {
